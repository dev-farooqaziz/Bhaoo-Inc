            ...
            <div className="container">
                ...
                <div className="grid grid-cols-12 items-center">
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <h5 className='text-[#438EFF] font-sans text-[20px] lg:text-[23px] font-[500] '>BookWritingCube</h5>
                        ...
                        <Link href="#" target="_blank" className='border-white border-2 text-white font-sans text-[16px] rounded-[12px] px-[30px] py-[8px] flex items-center w-fit gap-x-3 group'>
                            Learn More
                ...
                <div className="grid grid-cols-12 items-center my-14">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <h5 className='text-[#438EFF] font-sans text-[20px] lg:text-[23px] font-[500] '>BitsWits</h5>
                ...
                <div className="grid grid-cols-12 items-center">
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <h5 className='text-[#438EFF] font-sans text-[20px] lg:text-[23px] font-[500] '>NFTKreator</h5>
                ...
                <div className="grid grid-cols-12 items-center my-14">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <h5 className='text-[#438EFF] font-sans text-[20px] lg:text-[23px] font-[500] '>SEOResultsPro</h5>
                ...
                <div className="grid grid-cols-12 items-center">
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <h5 className='text-[#438EFF] font-sans text-[20px] lg:text-[23px] font-[500] '>LeadzExperts</h5>
                ...
                <div className="grid grid-cols-12 items-center my-14">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <h5 className='text-[#438EFF] font-sans text-[20px] lg:text-[23px] font-[500] '>bestsellingpublisher</h5>
                ...
                <div className="grid grid-cols-12 items-center">
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <h5 className='text-[#438EFF] font-sans text-[20px] lg:text-[23px] font-[500] '>infinityanimations</h5>
                ...
                <div className="grid grid-cols-12 items-center mt-14 lg:mb-14">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        ...
                        <h5 className='text-[#438EFF] font-sans text-[20px] lg:text-[23px] font-[500] '>explainervideosllc</h5>
