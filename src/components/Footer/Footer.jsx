...
const Footer = () => {
    return (
        <section>
            ...
            <div className="location borderImageleft py-[30px]">
                <div className="container">
                    <ul className='lg:w-10/12 mx-auto flex flex-col md:flex-row items-center justify-between gap-5 md:gap-0'>
                        ...
                        <li className='flex items-center gap-5'>
                            <Link href="mailto:info@xyz.com" className='text-white text-[13px] xl:text-[16px] font-sans flex items-center gap-3'>
                                <FaEnvelope className='lg:block hidden' />
                                info@xyz.com
                            </Link>
                            <Link href="tel:0123456789" className='text-white text-[13px] xl:text-[16px] font-sans flex items-center gap-3'>
            ...
            <div className="copyright borderImage py-[20px]">
                <div className="text-center flex justify-evenly items-center ">
                    <p className='font-sans text-white text-[14px] md:text-[20px] '>2025 – Bhaooinc – All Rights Reserved</p>
