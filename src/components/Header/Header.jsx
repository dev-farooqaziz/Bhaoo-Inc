                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="flex items-center justify-center gap-3 md:gap-5">
                            <div className="group">
                                <Link href="https://www.facebook.com/" className='p-3 w-full block text-white bg-[#02010100] border border-white rounded-full group-hover:border group-hover:border-blue-600 duration-700 ease-in-out group-hover:duration-700'>
                            ...
                            <div className="group">
                                <Link href="tel:0123456789" className='p-3 w-full block text-white bg-[#02010100] border border-white rounded-full group-hover:border group-hover:border-blue-600 duration-700 ease-in-out group-hover:duration-700'>
